...
CREATE INDEX "action_items_meeting_cache_id_idx" ON "action_items" USING btree ("meeting_cache_id");--> statement-breakpoint
CREATE INDEX "action_items_provider_external_id_idx" ON "action_items" USING btree ("provider","external_id");--> statement-breakpoint
CREATE INDEX "audit_log_user_id_idx" ON "audit_log" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "audit_log_action_idx" ON "audit_log" USING btree ("action");--> statement-breakpoint
CREATE UNIQUE INDEX "meetings_cache_user_provider_meeting_unique" ON "meetings_cache" USING btree ("user_id","provider","meeting_id");--> statement-breakpoint
CREATE INDEX "meetings_cache_user_id_idx" ON "meetings_cache" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "meetings_cache_provider_meeting_id_idx" ON "meetings_cache" USING btree ("provider","meeting_id");--> statement-breakpoint
CREATE UNIQUE INDEX "oauth_states_state_unique" ON "oauth_states" USING btree ("state");--> statement-breakpoint
CREATE INDEX "oauth_states_provider_state_idx" ON "oauth_states" USING btree ("provider","state");--> statement-breakpoint
...
CREATE INDEX "oauth_tokens_provider_idx" ON "oauth_tokens" USING btree ("provider");--> statement-breakpoint
